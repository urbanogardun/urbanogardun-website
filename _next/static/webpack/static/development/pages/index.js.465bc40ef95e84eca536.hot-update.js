      ...
      function sendMail() {
        $('.contact-form [type="submit"]').on('click', function () {
          ...
          if (isValidEmailAddress(email)) {
            // window.location.href = "mailto:" + email + "?subject=" + $('#subject').val() + "&body=" + $('#message').val();
            var link = document.createElement('a'); // link.href = '<?= $link ?>'

            link.href = 'mailto:johndoe@example.com';
            link.click(); // Email.send({
...
//# sourceMappingURL=index.js.465bc40ef95e84eca536.hot-update.js.map